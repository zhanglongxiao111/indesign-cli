...
class Catalog:
    def __init__(self, repo_root: Path, tools: list[dict[str, Any]] | None = None) -> None:
    ...
    def with_exposed_tools(
        ...
        *,
        ...
        return Catalog(repo_root=self.repo_root, tools=tools)

    def domains(self) -> list[dict[str, Any]]:
        source_counts: dict[str, Counter[str]] = {domain: Counter() for domain in DOMAINS}
        top_tools: dict[str, list[dict[str, Any]]] = {domain: [] for domain in DOMAINS}
