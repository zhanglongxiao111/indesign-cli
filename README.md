...
python scripts\build_agent_bootstrapper.py `
  ...
  --version 0.5.7 `
  --nas-url "\\daga-nas5\sa-ai-app\tools\indesign-cli\runtime-windows-x64-0.5.7.zip" `
  --github-url "https://github.com/zhanglongxiao111/indesign-cli/releases/download/v0.5.7/runtime-windows-x64-0.5.7.zip"
```
