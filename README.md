...
python scripts\build_agent_bootstrapper.py `
  ...
  --node-modules .\node_modules `
  --html-plugin-tgz <sa-html-indesign-0.2.7.tgz> `
  --version 0.5.8 `
  --nas-url "\\daga-nas5\sa-ai-app\tools\indesign-cli\runtime-windows-x64-0.5.8.zip" `
  --github-url "https://github.com/zhanglongxiao111/indesign-cli/releases/download/v0.5.8/runtime-windows-x64-0.5.8.zip"
```
