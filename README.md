...
python scripts\build_agent_bootstrapper.py `
  ...
  --node-modules .\node_modules `
  --html-plugin-tgz <sa-html-indesign-0.2.5.tgz> `
  --version 0.5.5 `
  --nas-url "\\daga-nas5\sa-ai-app\tools\indesign-cli\runtime-windows-x64-0.5.5.zip" `
  --github-url "https://github.com/zhanglongxiao111/indesign-cli/releases/download/v0.5.5/runtime-windows-x64-0.5.5.zip"
```
